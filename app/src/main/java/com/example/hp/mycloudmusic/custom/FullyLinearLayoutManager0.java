...
public class FullyLinearLayoutManager0 extends LinearLayoutManager {
    private static final String TAG = FullyLinearLayoutManager.class.getSimpleName();

    public FullyLinearLayoutManager0(Context context) {
        super(context);
    }

    public FullyLinearLayoutManager0(Context context, int orientation, boolean reverseLayout) {
